...
export default function CartDrawer({ open, onClose }: CartDrawerProps) {
  ...
  return (
    <div
      className={`fixed top-0 right-0 h-full w-96 bg-white shadow-2xl z-40 transform transition-transform duration-300 ease-in-out ${open ? 'translate-x-0' : 'translate-x-full'}`}
      style={{ boxShadow: open ? 'rgba(60,64,67,0.3) 0px 1.5px 8px 0px' : undefined }}
    >
